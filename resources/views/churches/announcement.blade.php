...
@section('modals')
    <create-announcement-modal :simbahan-id="simbahan.SimbahanID" @announcement-updated="OnAnnouncementUpdated"></create-announcement-modal>
...
@section('content')
    <box title="Church Announcements">
...
@section('scripts')
    <script src="{{ asset('js/church_announcement.js') }}"></script>
@endsection