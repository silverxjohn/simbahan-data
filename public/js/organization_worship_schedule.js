...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('schedule-field', {
    attrs: {
      "schedule": _vm.worshipSchedule.Time
    },
    on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-1c6afa80", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schedules_WorshipScheduleField_vue__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schedules_WorshipScheduleField_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__schedules_WorshipScheduleField_vue__);
...
var app = new Vue({
    ...
    methods: {
        ...
        GetWorshipDetails: function GetWorshipDetails(organizationId) {
            var _this = this;

            this.worshipDetails = [];
            axios.get(base_url + '/organizations/' + organizationId + '/worship-details').then(function (response) {
                _this.worshipDetails = response.data;
            });
        },
        OnWorshipDetailsUpdated: function OnWorshipDetailsUpdated() {
    ...
    components: {
        ...
        WorshipScheduleField: __WEBPACK_IMPORTED_MODULE_1__schedules_WorshipScheduleField_vue___default.a
    }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        CreateWorshipSchedule: function CreateWorshipSchedule(time) {
            var _this = this;
        ...
        UpdateWorshipSchedule: function UpdateWorshipSchedule(time) {
            ...
            axios.patch(base_url + '/organizations/' + this.worshipSchedule.OrganizationID + '/worship-details/' + this.worshipSchedule.OrgWorshipScheduleID, {
                ...
                _this2.$emit('worship-details-updated');
                alert('Worship Schedule has been updated successfully!');
                //swal('Success!', 'Worship Schedule has been updated successfully!', 'success');
            });
        },
        DeleteWorshipSchedule: function DeleteWorshipSchedule() {
            var _this3 = this;

            axios.delete(base_url + '/organizations/' + this.worshipSchedule.OrganizationID + '/worship-details/' + this.worshipSchedule.OrgWorshipScheduleID).then(function (response) {
                _this3.$emit('worship-details-updated');
        ...
        OnScheduleUpdated: function OnScheduleUpdated(time) {
            if (time == '') {
                ...
                if (deleteConfirmed) this.DeleteWorshipSchedule();else this.UpdateWorshipSchedule();
            } else if (this.worshipSchedule.OrgWorshipScheduleID != undefined || this.worshipSchedule.OrgWorshipScheduleID != null) this.UpdateWorshipSchedule(time);else this.CreateWorshipSchedule(time);
        }
    },
    components: {
...
Component.options.__file = "C:\\laragon\\www\\simbahan-data\\resources\\assets\\js\\modules\\organizations\\schedules\\WorshipScheduleField.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] WorshipScheduleField.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1c6afa80", Component.options)
  } else {
    hotAPI.reload("data-v-1c6afa80", Component.options)
  }
})()}
