...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('schedule-field', {
    attrs: {
      "schedule": _vm.confessionSchedule.Time
    },
    on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-51537060", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schedules_ConfessionScheduleField_vue__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schedules_ConfessionScheduleField_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__schedules_ConfessionScheduleField_vue__);
...
var app = new Vue({
    ...
    methods: {
        ...
        GetConfessionDetails: function GetConfessionDetails(simbahanId) {
            var _this = this;

            this.confessionDetails = [];
            axios.get(base_url + '/churches/' + simbahanId + '/confession-details').then(function (response) {
                _this.confessionDetails = response.data;
            });
        },
        OnConfessionDetailsUpdated: function OnConfessionDetailsUpdated() {
    ...
    components: {
        ...
        ConfessionScheduleField: __WEBPACK_IMPORTED_MODULE_1__schedules_ConfessionScheduleField_vue___default.a
    }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        CreateConfessionSchedule: function CreateConfessionSchedule(time) {
            var _this = this;
            ...
            axios.post(base_url + '/churches/' + this.confessionSchedule.SimbahanID + '/confession-details', {
                ...
                _this.$emit('confession-details-updated');
        ...
        DeleteConfessionSchedule: function DeleteConfessionSchedule() {
            var _this3 = this;

            axios.delete(base_url + '/churches/' + this.confessionSchedule.SimbahanID + '/confession-details/' + this.confessionSchedule.ConfessionID).then(function (response) {
                _this3.$emit('confession-details-updated');
        ...
        OnScheduleUpdated: function OnScheduleUpdated(time) {
            if (time == '') {
                ...
                if (deleteConfirmed) this.DeleteConfessionSchedule();else this.UpdateConfessionSchedule();
            } else if (this.confessionSchedule.ConfessionID != undefined || this.confessionSchedule.ConfessionID != null) this.UpdateConfessionSchedule(time);else this.CreateConfessionSchedule(time);
        }
    },
    components: {
...
Component.options.__file = "C:\\laragon\\www\\simbahan-data\\resources\\assets\\js\\modules\\churches\\schedules\\ConfessionScheduleField.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] ConfessionScheduleField.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-51537060", Component.options)
  } else {
    hotAPI.reload("data-v-51537060", Component.options)
  }
})()}
