...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        CreateBibleSchedule: function CreateBibleSchedule(time) {
            var _this = this;
        ...
        OnScheduleUpdated: function OnScheduleUpdated(time) {
            if (time == '') {
                ...
                if (deleteConfirmed) this.DeleteBibleSchedule();else this.UpdateBibleSchedule();
            } else if (this.bibleSchedule.OrgBibleScheduleID != undefined || this.bibleSchedule.OrgBibleScheduleID != null) this.UpdateBibleSchedule(time);else this.CreateBibleSchedule(time);
        }
    },
    components: {
...
Component.options.__file = "C:\\laragon\\www\\simbahan-data\\resources\\assets\\js\\modules\\organizations\\schedules\\BibleScheduleField.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] BibleScheduleField.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3e940722", Component.options)
  } else {
    hotAPI.reload("data-v-3e940722", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('schedule-field', {
    attrs: {
      "schedule": _vm.bibleSchedule.Time
    },
    on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3e940722", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schedules_BibleScheduleField_vue__ = __webpack_require__(223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schedules_BibleScheduleField_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__schedules_BibleScheduleField_vue__);
...
var app = new Vue({
    ...
    methods: {
        ...
        GetBibleDetails: function GetBibleDetails(organizationId) {
            var _this = this;

            this.bibleDetails = [];
            axios.get(base_url + '/organizations/' + organizationId + '/bible-details').then(function (response) {
                _this.bibleDetails = response.data;
            });
        },
        OnBibleDetailsUpdated: function OnBibleDetailsUpdated() {
    ...
    components: {
        ...
        BibleScheduleField: __WEBPACK_IMPORTED_MODULE_1__schedules_BibleScheduleField_vue___default.a
    }
});
